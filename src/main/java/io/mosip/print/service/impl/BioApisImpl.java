 ...
 */
@Component
public class BioApisImpl implements IBioApis {

	/*
	 * (non-Javadoc)
	 * 
	 * @see
	 * io.mosip.kernel.core.bioapi.spi.IBioApis#checkQuality(io.mosip.kernel.core.
	 ...
	 * 
	 * @see
	 * io.mosip.kernel.core.bioapi.spi.IBioApis#match(io.mosip.kernel.core.bioapi.
	 ...
	 * 
	 * @see
	 * io.mosip.kernel.core.bioapi.spi.IBioApis#extractTemplate(io.mosip.kernel.core.
	 * bioapi.model.BIR, io.mosip.kernel.core.bioapi.model.KeyValuePair[])
	 */
	@Override
	 ...
	 * 
	 * @see
	 * io.mosip.kernel.core.bioapi.spi.IBioApis#segment(io.mosip.kernel.core.bioapi.
